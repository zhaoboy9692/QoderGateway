    ...
    <main className="min-h-screen bg-surface relative overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 text-sm font-bold">
          ...
          <a href="https://github.com/zhaoboy9692/QoderGateway" target="_blank" rel="noreferrer" className="w-10 h-10 inline-flex items-center justify-center rounded-full border border-hairline bg-white/70 text-ink hover:bg-white transition-all" aria-label="GitHub Repository">
